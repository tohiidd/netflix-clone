    ...
    <section>
      ...
      <section>
        <List
          ...
          isLarge
        />
        <List fetchUrl={requests.fetchActionMovies} title={"Action"} />
        <List fetchUrl={requests.fetchComedyMovies} title={"Drama"} />
        <List fetchUrl={requests.fetchHorrorMovies} title={"Science Fiction"} />
